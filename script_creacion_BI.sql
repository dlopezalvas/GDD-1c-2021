...
CREATE TABLE [BREAKFAST_CLUB].[BI_HECHOS_VENTAS_PC] (
  ...
  CONSTRAINT cod_hechos_ventas_pc_pk PRIMARY KEY ([COD_PC], [COD_SUCURSAL], [COD_TIEMPO], [EDAD])
);
...
CREATE TABLE [BREAKFAST_CLUB].[BI_HECHOS_COMPRAS_PC] (
  ...
  [GANANCIAS_MES_SUC] decimal(18,0),
  CONSTRAINT cod_hechos_compras_pc_pk PRIMARY KEY ([COD_PC], [COD_SUCURSAL], [COD_TIEMPO])
);
...
CREATE TABLE [BREAKFAST_CLUB].[BI_HECHOS_VENTAS_ACCESORIOS] (
  ...
  CONSTRAINT cod_hechos_ventas_acc_pk PRIMARY KEY ([COD_ACCESORIO], [COD_SUCURSAL], [COD_TIEMPO], [EDAD])
);
...
CREATE TABLE [BREAKFAST_CLUB].[BI_HECHOS_COMPRAS_ACCESORIOS] (
  ...
  [MAX_STOCK_ANUAL_SUCURSAL] decimal(18,0),
  [GANANCIAS_MES_SUC] decimal(18,0),
  CONSTRAINT cod_hechos_compras_acc_pk PRIMARY KEY ([COD_ACCESORIO], [COD_SUCURSAL], [COD_TIEMPO])
);
