...
CREATE TABLE [BREAKFAST_CLUB].[BI_HECHOS_PC] (
  ...
  [COD_DISCO] nvarchar(255) REFERENCES [BREAKFAST_CLUB].[BI_DISCO],
  ...
  CONSTRAINT ck_tipo_transaccion_pc CHECK ([TIPO_TRANSACCION] IN ('Compra','Venta'))
);

CREATE TABLE [BREAKFAST_CLUB].[BI_HECHOS_ACCESORIOS] (
  [TIPO_TRANSACCION] nvarchar(50),
  [COD_ACCESORIO] nvarchar(255) REFERENCES [BREAKFAST_CLUB].[BI_ACCESORIO],
  [COD_SUCURSAL] decimal (18,0) REFERENCES [BREAKFAST_CLUB].[BI_SUCURSAL],
  [COD_TIEMPO] decimal(18,0) REFERENCES [BREAKFAST_CLUB].[BI_TIEMPO],
  [PRECIO] decimal(18,2) ,
  [CANTIDAD] decimal(18,0),
  ...
  [STOCK_DISPONIBLE] decimal(18,0) NULL,
  [TIEMPO_EN_STOCK] decimal(18,0)
  CONSTRAINT ck_tipo_transaccion_acc CHECK ([TIPO_TRANSACCION] IN ('Compra','Venta'))
);
...
GROUP BY PC.COD_PC, COD_GPU,  COD_RAM, COD_DISCO, COD_CPU, S.COD_SUCURSAL, F.COD_CLIENTE, PxF.PRECIO, F.FECHA
COMMIT;
