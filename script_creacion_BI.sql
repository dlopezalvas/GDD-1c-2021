...
BEGIN TRANSACTION
	...
	BEGIN TRANSACTION
	UPDATE [BREAKFAST_CLUB].[BI_HECHOS_COMPRAS_ACCESORIOS] SET [MAX_STOCK_ANUAL_SUCURSAL] = [BREAKFAST_CLUB].STOCK_MAX_EN_ANIO(COD_SUCURSAL, COD_TIEMPO), 
	...
	SELECT COD_TIEMPO, COD_SUCURSAL, COD_ACCESORIO, [BREAKFAST_CLUB].STOCK_MAX_EN_ANIO(COD_SUCURSAL, COD_TIEMPO),
	[BREAKFAST_CLUB].GANANCIAS_ACCESORIOS(COD_TIEMPO, COD_SUCURSAL),
	[BREAKFAST_CLUB].TOTAL_VENDIDO_X_MES_SUC_ACC(COD_TIEMPO, COD_SUCURSAL, COD_ACCESORIO)
	FROM (SELECT DISTINCT COD_TIEMPO, COD_SUCURSAL, COD_ACCESORIO FROM [BREAKFAST_CLUB].BI_HECHOS_VENTAS_ACCESORIOS) V
...
BEGIN TRANSACTION
	...
	BEGIN TRANSACTION
	UPDATE [BREAKFAST_CLUB].[BI_HECHOS_COMPRAS_PC] SET [GANANCIAS_MES_SUC] = [BREAKFAST_CLUB].GANANCIAS_PC(COD_TIEMPO, COD_SUCURSAL)
	COMMIT;
	...
	FROM (SELECT DISTINCT COD_TIEMPO, COD_SUCURSAL, COD_PC FROM [BREAKFAST_CLUB].BI_HECHOS_VENTAS_PC) V
